...
const LoginPage = () => {
  ...
  >
    ...
    <text x="47" y="20" fontSize="6" fill="#4facfe" fontFamily="sans-serif">****</text>
          ...
          <section aria-label="Email login form">
            <h2 id="email-login-form" className="sr-only">Email Login Form</h2>
            <form onSubmit={handleEmailLogin} className="w-80 text-base" role="form" aria-labelledby="email-login-form">
